...
#define VESTRINGHASH(x) (VeritasEngine::crc32<sizeof(x) - 2>(x) ^ 0xFFFFFFFF)
...
namespace VeritasEngine
{
	...
	{
		return index == -1 ? 0xFFFFFFFF : ((Hash(str, index - 1) >> 8) ^ crc_table[(Hash(str, index - 1) ^ str[index]) & 0x000000FF]);
	}
